...
export const InvitationsContext = createContext<{ invitations: Invitation[], loading: boolean }>({ loading: false, invitations: [] });
export const SammlungenContext = createContext<{ sammlungen: Sammlung[], loading: boolean }>({ loading: false, sammlungen: [] });
